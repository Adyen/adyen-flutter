...
class DropInConfigurationDTO {
  ...
  static DropInConfigurationDTO decode(Object result) {
    ...
    return DropInConfigurationDTO(
      ...
      analyticsOptionsDTO: result[10]! as AnalyticsOptionsDTO,
      showPreselectedStoredPaymentMethod: result[11]! as bool,
      skipListWhenSinglePaymentMethod: result[12]! as bool,
      isRemoveStoredPaymentMethodEnabled: result[13]! as bool,
      preselectedPaymentMethodTitle: result[14] as String?,
      paymentMethodNames:
          (result[15] as Map<Object?, Object?>?)?.cast<String?, String?>(),
      isPartialPaymentSupported: result[16]! as bool,
    );
  }
}
