...
class CheckoutPlatformInterface {
  ...
  Future<String> encrypt(UnencryptedCardDTO unencryptedCardDTO, String publicKey) async {
    const String __pigeon_channelName = 'dev.flutter.pigeon.adyen_checkout.CheckoutPlatformInterface.encrypt';
    final BasicMessageChannel<Object?> __pigeon_channel = BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
      binaryMessenger: __pigeon_binaryMessenger,
