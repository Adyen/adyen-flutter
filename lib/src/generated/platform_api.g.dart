...
class DropInPlatformInterface {
  ...
  Future<void> showDropInSession(DropInConfigurationDTO dropInConfigurationDTO, SessionDTO sessionDTO) async {
    ...
    final List<Object?>? __pigeon_replyList =
        await __pigeon_channel.send(<Object?>[dropInConfigurationDTO, sessionDTO]) as List<Object?>?;
    if (__pigeon_replyList == null) {
      throw _createConnectionError(__pigeon_channelName);
    } else if (__pigeon_replyList.length > 1) {
      throw PlatformException(
  ...
  Future<void> cleanUpDropInAdvanced() async {
    const String __pigeon_channelName = 'dev.flutter.pigeon.adyen_checkout.DropInPlatformInterface.cleanUpDropInAdvanced';
    final BasicMessageChannel<Object?> __pigeon_channel = BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
      binaryMessenger: __pigeon_binaryMessenger,
  ...
  Future<void> cleanUpDropInSession() async {
    const String __pigeon_channelName = 'dev.flutter.pigeon.adyen_checkout.DropInPlatformInterface.cleanUpDropInSession';
    final BasicMessageChannel<Object?> __pigeon_channel = BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
      binaryMessenger: __pigeon_binaryMessenger,
