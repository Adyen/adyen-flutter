...
class AdyenCheckout implements AdyenCheckoutInterface {
  ...
  static final AdyenLogger _adyenLogger = AdyenLogger.instance;
  ...
  static AdyenCheckoutAdvanced get advanced =>
      _advanced ??= AdyenCheckoutAdvanced(_adyenCheckoutApi);

  static AdyenCheckoutSession get session =>
      _session ??= AdyenCheckoutSession(_adyenCheckoutApi);
