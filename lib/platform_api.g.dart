...
class SessionDropInResult {
  ...
  static SessionDropInResult decode(Object result) {
    result as List<Object?>;
...
class _DropInSessionsApiCodec extends StandardMessageCodec {
  const _DropInSessionsApiCodec();
  @override
...
class DropInSessionsApi {
  /// Constructor for [DropInSessionsApi].  The [binaryMessenger] named argument is
  /// available for dependency injection.  If it is left null, the default
  /// BinaryMessenger will be used which routes to the host platform.
  DropInSessionsApi({BinaryMessenger? binaryMessenger})
      : _binaryMessenger = binaryMessenger;
  final BinaryMessenger? _binaryMessenger;

  static const MessageCodec<Object?> codec = _DropInSessionsApiCodec();

  Future<void> startPayment(SessionModel arg_sessionModel, DropInConfiguration arg_dropInConfiguration) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.adyen_checkout.DropInSessionsApi.startPayment', codec,
...
class _FlutterCommunicationApiCodec extends StandardMessageCodec {
  const _FlutterCommunicationApiCodec();
  @override
  void writeValue(WriteBuffer buffer, Object? value) {
    if (value is SessionDropInResult) {
      buffer.putUint8(128);
      writeValue(buffer, value.encode());
    } else {
      super.writeValue(buffer, value);
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      case 128: 
        return SessionDropInResult.decode(readValue(buffer)!);
      default:
        return super.readValueOfType(type, buffer);
    }
  }
...
abstract class FlutterCommunicationApi {
  static const MessageCodec<Object?> codec = _FlutterCommunicationApiCodec();

  void onDropInResult(SessionDropInResult sessionDropInResult);

  static void setup(FlutterCommunicationApi? api, {BinaryMessenger? binaryMessenger}) {
    {
      final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.adyen_checkout.FlutterCommunicationApi.onDropInResult', codec,
      ...
      if (api == null) {
        ...
        channel.setMessageHandler((Object? message) async {
          assert(message != null,
          'Argument for dev.flutter.pigeon.adyen_checkout.FlutterCommunicationApi.onDropInResult was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final SessionDropInResult? arg_sessionDropInResult = (args[0] as SessionDropInResult?);
          assert(arg_sessionDropInResult != null,
              'Argument for dev.flutter.pigeon.adyen_checkout.FlutterCommunicationApi.onDropInResult was null, expected non-null SessionDropInResult.');
          api.onDropInResult(arg_sessionDropInResult!);
          return;
        });
      }
    }
