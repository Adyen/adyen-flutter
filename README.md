...
2. In your Flutter app, create an `InstantComponentConfiguration`.
...
```
4. Get your required instant payment method by filtering the payment methods list provided by the `SessionCheckout`.
