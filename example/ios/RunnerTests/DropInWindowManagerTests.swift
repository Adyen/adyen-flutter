...
final class DropInWindowManagerTests: XCTestCase {
    ...
    func test_givenDropInIsPresented_whenCleanedUp_thenTearsDownDropInWindow() throws {
        ...
        XCTAssertFalse(dropInWindow?.rootViewController === dropInViewController)
        XCTAssertTrue(dropInWindow?.rootViewController?.presentedViewController === dropInViewController)
