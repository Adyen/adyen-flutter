...
struct ThreeDS2UICustomizationDTO {
    ...
    static func fromList(_ __pigeon_list: [Any?]) -> ThreeDS2UICustomizationDTO? {
        ...
        let primaryButtonCustomization: ThreeDS2ButtonCustomizationDTO? = nilOrValue(__pigeon_list[4])
        let secondaryButtonCustomization: ThreeDS2ButtonCustomizationDTO? = nilOrValue(__pigeon_list[5])
