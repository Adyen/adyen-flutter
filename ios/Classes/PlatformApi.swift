...
enum ApplePayFundingSource: Int {
  case debit = 0
  case credit = 1
}
...
struct ApplePayConfigurationDTO {
  ...
  var supportedNetworks: [String?]? = nil
  ...
  var merchantCapability: ApplePayFundingSource? = nil
  ...
  static func fromList(_ list: [Any?]) -> ApplePayConfigurationDTO? {
    ...
    let supportsCouponCode: Bool? = nilOrValue(list[13])
    let couponCode: String? = nilOrValue(list[14])
    var merchantCapability: ApplePayFundingSource? = nil
    let merchantCapabilityEnumVal: Int? = nilOrValue(list[15])
    if let merchantCapabilityRawValue = merchantCapabilityEnumVal {
      merchantCapability = ApplePayFundingSource(rawValue: merchantCapabilityRawValue)!
    }
...
struct ApplePayShippingMethodDTO {
  ...
  static func fromList(_ list: [Any?]) -> ApplePayShippingMethodDTO? {
    ...
    let detail: String? = nilOrValue(list[1])
