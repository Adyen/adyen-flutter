...
constructor(
    ...
    fun <T> addComponent(component: T, componentId: String) where T : ViewableComponent, T : Component {
    ...
    private fun updateComponentViewHeight(componentId: String) {
        ...
        componentFlutterApi.onComponentCommunication(
            ComponentCommunicationModel(
                type = ComponentCommunicationType.RESIZE, componentId = componentId, data = roundedHeight
            )
        ) {}
    }
}
